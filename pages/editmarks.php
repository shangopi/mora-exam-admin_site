  ...
  <div class="container">
    <div class="card card-plain">
      <div class="card-header card-header-primary">
        ...
        <h4 class="card-title text mt-0"> Edit Part <?php echo $_GET['part']?> of  <?php echo ucfirst($_GET['subject'])?></h4>
            ...
            <form id="frm1" onSubmit="search();return false;"  method="POST" id="frm">
                <div class="row">
                  <div class="col-md-4 ">
                    <div class="form-group">
                      ...
                      <input type="text" VALUE="<?php if(isset($_GET['index_no'])){    echo $_GET['index_no']; } ?>" autofocus id="index_no" pattern="[0-9]{6}"
                ...
                <br>
                    <div class="form-group col-md-12 text-center">
                      <button  id="submit1" class="btn btn-warning"><i class="fa fa-edit"> </i> &nbsp &nbsp Edit</button>
