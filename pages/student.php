...
$sql_students = "SELECT * FROM tbl_students ORDER BY datetime DESC;";
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if ($list[2] == "MATHS") {
                    ...
                    $('#exampleRadios9').removeAttr('checked');
                } else if ($list[2] == "BIO") {
                ...
                else if ($list[2] == "Other" || $list[2] == "Other") {
                    $('#exampleRadios6').removeAttr('checked');
                    $('#exampleRadios7').removeAttr('checked');
                    $('#exampleRadios5').removeAttr('checked');
                    $('#exampleRadios8').removeAttr('checked');
    ...
    function view(index_no) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // $alert($list[18]);('#dyn_txt').html($list);
                $('#modal1').modal('show');
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <i class="material-icons">supervisor_account</i> &nbsp; Entered By
                                                        </span>
                                                    </div>
                                                    <input id="enter1" readonly type="text"
                                                        value="Gopi" class="form-control">
                                                </div>
                                            </td>
                                            <td class="td-actions text-right">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <i class="material-icons">check</i> &nbsp; Checked By
                                                        </span>
                                                    </div>
                                                    <input id="check1" readonly type="text"
                                                        value="Gopi" class="form-control">
                                                </div>
                                            </td>
                                            <td class="td-actions text-right">
